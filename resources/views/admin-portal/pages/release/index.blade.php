                    ...
                    <tbody>
                      @forelse ($releases as $index=>$item)
                        <tr>
                            ...
                            <button class="btn btn-outline-primary p-1 m-1" onclick='window.location.href="{{route('admin.release.show', $item->id)}}"' ><i class="fa fa-eye"></i></button>
                            <a class="btn btn-outline-danger p-1 m-1"  href="{{route('admin.deleteRelease', $item->id)}}" onclick='return confirm("Are you sure?")'  ><i class="fa fa-trash"></i></a>
                            <a class="btn btn-outline-warning p-1 m-1"  href="javascript:;" onclick='addStreams("{{$item->id}}",$(this),"{{$item->user_id}}")' data-track="{{$item->album_title}}" data-artist="{{isset($item->user) ? $item->user->name : null}}" ><i class="fa fa-headphones"></i></a>
                            </td>
                        </tr>
                      @empty
