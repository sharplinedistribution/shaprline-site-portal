        ...
        <div class="row bg-dark p-4">
            ...
            <div class="col-lg-12 mt-4">
                <div class="frequentlyQsts">
                    <h2 style="color: #fbda03;">{{++$index}}. {{$track->title}} @if(isset($track->track_version)) ({{ $track->track_version }}) @endif - {{getFirstArtist($track->artist)}}</h2>

                </div>
            </div>
            <div class="col-12">
                <p class="mb-2">ISRC CODE  - {{isset($track->isrc_code) ? $track->isrc_code : '-'}}&nbsp;<a href="javascript:;" onClick="updateTrack($(this),'{{ $track->isrc_code }}',{{ $track->id }})"><i class="fa fa-edit" style="color:#fbda03"></i></a></p>
