        ...
        <div class="col-12 grid-margin">
            <div class="card mb-5">
                <div class="card-body">
                    ...
                    <h4 class="card-title"><a href="{{ route('admin.royaltySplit.index') }}"><i class="fa fa-arrow-left" style="color:yellow"></i></a>&nbsp;Royalty Split Detail</h4>
                   <center>
                    <img src="{{asset(config('upload_path.album_artwork').$release->album_artwork)}}" class="card-img-top" alt="..." style="height:200px; width:200px;"><br>
                    <h3 class="mt-2">{{ $release->album_title }}</h3>
                   </center>
                   <hr>
                   ...
                   @foreach($royaltySplits as $index=>$rs)
                    <div class="row mb-1">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <h5 style="color:yellow;">{{ isset($rs->track->title) ? $rs->track->title : '-' }}</h5>
