...
@endpush
@section('content')
<section class="terms-main-headign">
    <div class="container">
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <div class="our-work">
                    <h1 class="font-oswald fw-bold text-color-primary text-capitalize mb-3" style="font-size:50px;">Sharpline Distro Website Terms of Services</h1>
                    ...
                    <p>terms of our Privacy Policy and Cookie Policy and the use of personal information described in both policies.</p>
                </div>
            </div>
        </div>
    </div>
