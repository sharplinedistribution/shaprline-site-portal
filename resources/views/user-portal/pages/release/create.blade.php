...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <input name="album_title" type="text" class="form-control text-white" id="alTitle"
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <input type="text" name="upc_code" id="upc" class="form-control text-white"
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text-white" name="label" id="label"
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text-white" name="version" id="version"
                        placeholder="Leave a blank if orginal">
                </div>
            </div>
        </div>
        <div class="row input-group-list">
            ...
            <div class="col-lg-7">
                <div class="form-group">
                    <label for=""></label>
                    <input type="text" name="artist[0][name]" id=""
                        class="form-control artist_name text-white" placeholder="Artist Name" required>
                </div>
            </div>
            <div class="col-lg-1 d-flex align-items-center justify-content-between p-0 mt-4">
                <div class="form-group d-flex align-items-center form-remove-add">
                    <a href="javascript:;" id="addArtist" class="addInput" onClick="addInput($(this),'artist')"
                        data-id="0">+</a>
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <input type="text" name="release_date" id="release_date"
                        class="form-control text-white datepicker" required readonly
                        style="background: #2A3038; color: white !important;">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                ...
                <p class="upload-msg text-danger" style="width:auto !important">Please upload image with resolution (1000
                    x 1000)</p>
                <div class="form-group">
                    <div class="image-album" style="display:none ;">
                        <span class="cross">x</span>
                        <img id="uploadedImage" src="#" alt="Uploaded Image" accept="image/png, image/jpeg"
                            style="display:none;" class="img-upload-album">
                    </div>
                    ...
                    <input type='file' id="readUrl" name="album_artwork" class="form-control" required
                        accept="image/*">
                    <img id="uploadedImage" src="#" alt="Uploaded Image" accept="image/png, image/jpeg"
                        style="display:none;">
                </div>
        ...
        <div class="col-lg-12 mt-2">
            ...
            <select name="stores[]" id="stores" class="form-control select2" multiple style="background: #2A3038"
                required>
            ...
            <div class="row mt-5 bg-dark p-3 ">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="track_title" class="form-control track_title text-white"
                            placeholder="Track Title" required style="color:white;">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                ...
                <div class="row input-group-list w-100 m-0">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for=""></label>
                            <input type="text" name="artist_track_name[]" required id=""
                                class="form-control text-white" placeholder="Artist Name">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for=""></label>
                            <input type="text" name="artist_track_spotify[]" required id=""
                                class="form-control text-white"
                                placeholder="Spotify Link. Leave blank if you do not have">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for=""></label>
                            <input type="text" name="artist_track_apple[]" required id=""
                                class="form-control text-white" placeholder="Apple Link. Leave blank if you do not have">
                        </div>
                    </div>
                    <div class="col-lg-1 d-flex align-items-center justify-content-between p-0 mt-4">
                        <div class="form-group d-flex align-items-center form-remove-add">
                            <a href="javascript:;" id="artistTrack" class="addInput" onClick="addInput($(this),2)"
                                data-id="0">+</a>
                            {{-- <a href="javascript:;"  id="removeArtist" class="removeInput" onClick="removeInput($(this),'artist')" data-id="0">x</a> --}}
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-check form-check-warning">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="track_contains_1" id="ExampleRadio5"
                                value="Instrumental">Instrumental <i class="input-helper"></i></label>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-check form-check-warning">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="track_contains_2" id="ExampleRadio4"
                                value="Explicit">Explicit <i class="input-helper"></i></label>
                        <span>My Song contain any profanity (Includes title & artwork)</span>
                    </div>
                    <div class="form-check form-check-warning">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="track_contains_2" id="ExampleRadio4"
                                value="Radio Edit">Radio Edit <i class="input-helper"></i></label>
                ...
                <div class="col-lg-12 mt-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="track_language" requried id=""
                            class="form-control text-white">
                    </div>
                </div>
            </div>
            <div class="row bg-dark " style="padding-right:17px; padding-left:17px;">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <select name="songwriters_type[]" required id=""
                            class="form-control tracksongwriter_type">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        ...
                        <input type="text" name="songwriters_name[]" required id=""
                            class="form-control tracksongwriter_name text-white" placeholder="Name">
                    </div>
                </div>
                <div class="col-lg-1">
                    <label for="writters">&nbsp;</label>
                    <div class="form-group d-flex align-items-center form-remove-add-p2">
                        <a href="javascript:;" id="songWriter" class="addInput" onclick="addInput($(this),3)"
                            data-id="0">+</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="file-upload-wrapper">
                        <div class="card card-body w-100 view file-upload">
                            <input type="file" onchange="previewFile(1)" name="track_audio_file" accept="audio/wav"
                                class="audiofile a_1 browseFile">
                            <p class="file-upload-infos-message" id="audioMsg_1">Audio upload - Drag and drop or click</p>
                            <small class="text-danger" id="audioTrackMsg" style="display:none">Track Size is larger than
                                30 MB</small>
                        </div>
                        <div class="card card-body w-100 ">
                            <audio controls src="" id="audio_1" width="100%"
                                style="background:#fbda03; display:none"></audio>
                        </div>
                        ...
                        <small style="display: none" class="showloaderMsg">Please do not close or refresh the browser.
                            After this loading click on Add Track Button.</small>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-12 text-right mt-3 mb-3">
            <button type="button" id="addTrack" data-id="1" class="btn btn-lg" onClick="uploadTrack($(this))"
                style="background-color: #fbda03; color: #333;">Add Track</button>
        </div>
    </div>
    <div class="row mt-5 bg-dark p-3 mb-5">
        ...
        <div class="col-lg-12">
            <div class="form-check form-check-warning">
                <label class="form-check-label">
                    <input type="checkbox" class="form-check-input" name="check1" required id="check1"> I accept
                    that I can only
            ...
            <div class="form-check form-check-warning">
                <label class="form-check-label">
                    <input type="checkbox" class="form-check-input" name="check2" required id="check2">I recorded
                    this music
            ...
            <div class="form-check form-check-warning">
                <label class="form-check-label">
                    <input type="checkbox" class="form-check-input" name="check3" required id="check3"> I agree that
                    the
            ...
            <div class="form-check form-check-warning">
                <label class="form-check-label">
                    <input type="checkbox" class="form-check-input" name="check4" required id="check4"> I do not use
                    the
            ...
            <div class="form-check form-check-warning">
                <label class="form-check-label">
                    <input type="checkbox" class="form-check-input" name="check5" required id="check5"> I have read
                    and
        ...
        <div class="col-lg-12 mt-4">
            <small class="text-danger  " id="active_message">Add your First track this button will be enable on your first
                upload.<br> Upload Your Track and hit on Add Track button</small>
            <br>
            <span class="badge bg-danger mb-3" id="msg_no_of_songs" style="display: none">You have selected <span
                    class="no_of_songs">1</span> tracks. Please upload <span class="no_of_songs">1</span> tracks to enable
                this button</span><br>
            <button type="submit" class="btn btn-block btn-lg" id="createRelease"
                style="background-color:#fbda03; color: #333;" disabled>Create
                Release</button>
        </div>
    </div>
    <!-- Modal -->
    <div class="modal fade" id="editTrack" tabindex="-1" role="dialog" aria-labelledby="editTrack"
        aria-hidden="true">
...
@push('scripts')
    ...
    <script>
        ...
        function artist(count) {
            alert(count);
            var html = '<div class="col-lg-4 artist_' + count +
                '"> <div class="form-group">  <select class="form-control artist" id="exampleFormControlSelect2" name="artist[' +
                count +
                '][type]" required> <option value="primary artist">Primary Artist</option> <option value="featured artist">Featured Artist</option> </select> </div> </div> <div class="col-lg-7 artist_' +
                count + '"> <div class="form-group">  <input type="text" name="artist[' + count +
                '][name]" id="" class="form-control artist_name text-white" placeholder="Artist Name" required> </div> </div> <div class="col-lg-1 d-flex align-items-center justify-content-between p-0  artist_' +
                count +
                '"> <div class="form-group d-flex align-items-center form-remove-add">  <a href="javascript:;" class="removeInput" onClick="removeInput($(this))" data-id=' +
                count + ' data-type="artist">x</a> </div> </div> ';
            return html;
        }

        function track(count) {
            var html = '<div class="col-lg-2 artist_track_' + count +
                '"> <div class="form-group">  <select class="form-control artist" id="exampleFormControlSelect2" name="artist_track_type[]" required > <option value="primary artist">Primary Artist</option> <option value="featured artist">Featured Artist</option> </select> </div> </div> <div class="col-lg-3 artist_track_' +
                count +
                '"> <div class="form-group">  <input type="text" name="artist_track_name[]" required id="" class="form-control artist_name text-white" placeholder="Artist Name"> </div> </div>  <div class="col-lg-3 artist_track_' +
                count +
                '"> <div class="form-group">  <input type="text" name="artist_track_spotify[]" required id="" class="form-control artist_spotify text-white" placeholder="Spotify Link. Leave blank if you do not have"> </div> </div>  <div class="col-lg-3 artist_track_' +
                count +
                '"> <div class="form-group">  <input type="text" name="artist_track_apple[]" required id="" class="form-control artist_apple text-white" placeholder="Apple Link. Leave blank if you do not have"> </div> </div>  <div class="col-lg-1 d-flex align-items-center justify-content-between p-0  artist_track_' +
                count +
                '"> <div class="form-group d-flex align-items-center form-remove-add">  <a href="javascript:;" class="removeInput" onClick="removeInput($(this))" data-id=' +
                count + ' data-type="artistTrack">x</a> </div> </div> ';
            return html;
        }

        function songWriters(count) {
            var html = '<div class="col-lg-4 songwriters_track_' + count +
                '"> <div class="form-group"> <select name="songwriters_type[]" required id="" class="form-control"> <option value="Composer & Writer">Composer & writer</option> <option value="Composer">Composer</option> <option value="Lyricist">Lyricist</option> <option value="Producer">Producer</option> <option value="Publisher">Publisher</option> </select> </div> </div> <div class="col-lg-7 songwriters_track_' +
                count +
                '" > <div class="form-group"> <input type="text" name="songwriters_name[]" required id="" class="form-control text-white" placeholder="Name"> </div> </div> <div class="col-lg-1 songwriters_track_' +
                count +
                '" > <div class="form-group d-flex align-items-center form-remove-add-p2">  <a href="javascritpt:;" class="removeInput" onClick="removeInput($(this))" data-id="' +
                count + '" data-type="songWriter">x</a> </div>';
            return html;
        }
        ...
        function multiTrack(count, trackId, track_title) {
            $("#multiTracks").append('<div class="row mt-5 bg-dark p-5 " id="track_msg_' + count +
                '" style="margin: -42px;"> <div class="col-md-12"> <h2 class="text-center trackUploaded" ><i class="fa fa-check text-success"></i>&nbsp;&nbsp;(' +
                count + ') ' + track_title +
                ' Uploaded</h2> <div class="text-center"> <a href="javascript:;" onClick="editTrack(' + trackId +
                ',$(this))"  data-count="' + count + '" data-name="' + track_title +
                '"><i class="fa fa-pencil text-success d-none" style="font-size:25px"></i></a>&nbsp;&nbsp;<a href="javascript:;" onClick="deleteTrack(' +
                trackId + ',$(this))" data-count="' + count + '" data-name="' + track_title +
                '"><i class="fa fa-trash text-danger" style="font-size:25px;"></i></a> </div></div> </div>');
        }
        ...
        function noOfSongs(i) {
            text = '<div id="track_' + i +
                '"><div class="row mt-5 bg-dark p-3"> <div class="col-lg-12"><div class="form-group"> <label for="titleTrack">' +
                i + '. Track Title</label> <input type="text" name="track_title" id="track_title_' + i +
                '" class="form-control track_title text-white" placeholder="Track Title"></div> </div> <div class="col-lg-12"> <div class="form-group"> <label for="isrc">ISRC CODE</label> <input type="text" class="form-control text-white" id="isrc" name="track_isrc_code" value="" placeholder="If you do not have one. Leave blank we will generate one for free">  </div> </div><div class="col-lg-2"> <div class="form-group"> <label for="artist">Artist</label> <select class="form-control" id="exampleFormControlSelect2" name="artist_track_type[]" required> <option value="primary artist">Primary Artist</option> <option value="featured artist">Featured Artist</option> </select> </div> </div> <div class="col-lg-3"> <div class="form-group"> <label for=""></label> <input type="text" name="artist_track_name[]" required id="" class="form-control text-white" placeholder="Artist Name"> </div> </div> <div class="col-lg-3"> <div class="form-group"> <label for=""></label> <input type="text" name="artist_track_spotify[]" required id="" class="form-control text-white" placeholder="Spotify Link. Leave blank if you do not have"> </div> </div> <div class="col-lg-3"> <div class="form-group"> <label for=""></label> <input type="text"  name="artist_track_apple[]" required id="" class="form-control text-white" placeholder="Apple Link. Leave blank if you do not have"> </div> </div> <div class="col-lg-1 d-flex align-items-center justify-content-between p-0 mt-4"> <div class="form-group d-flex align-items-center form-remove-add"><a href="javascript:;" id="artistTrack" class="addInput" onclick="addInput($(this),2)" data-id="' +
                i + '">+</a></div></div><div class="row input-group-list w-100 m-0 trackArtist"> </div>';
            text +=
                '<div class="col-lg-12"> <hr class="hr-releases"> <div class="form-check form-check-warning"> <label class="form-check-label"> <input type="radio" class="form-check-input" name="track_contains_1" id="ExampleRadio' +
                i +
                '"  value="Contain Vocals"> Contain Vocals <i class="input-helper"></i></label> <span>My Song contains lyrics and vocals</span> </div> <div class="form-check form-check-warning"> <label class="form-check-label"> <input type="radio" class="form-check-input" name="track_contains_1" id="ExampleRadio' +
                i +
                '"  value="Instrumental">Instrumental <i class="input-helper"></i></label> <span>My Song contains no lyrics and vocals</span> </div> </div> <div class="col-lg-12"> <hr class="hr-releases"> <div class="form-check form-check-warning"> <label class="form-check-label"> <input type="radio" class="form-check-input" name="track_contains_2" id="ExampleRadio1' +
                i +
                '"  value="Clean"> Clean <i class="input-helper"></i></label> <span>My Song does not contain any profanity (Includes title & artwork)</span> </div> <div class="form-check form-check-warning"> <label class="form-check-label"> <input type="radio" class="form-check-input" name="track_contains_2" id="ExampleRadio1' +
                i +
                '"  value="Explicit">Explicit <i class="input-helper"></i></label> <span>My Song contain any profanity (Includes title & artwork)</span> </div> <div class="form-check form-check-warning"> <label class="form-check-label"> <input type="radio" class="form-check-input" name="track_contains_2" id="ExampleRadio1' +
                i +
                '"  value="Radio Edit">Radio Edit <i class="input-helper"></i></label> <span>The track is clean/censored, but have a explict version.</span> </div> <hr class="hr-releases"> </div> <div class="col-lg-12 mt-3"> <div class="form-group"> <label for="language">Language</label> <input type="text" name="track_language" requried id="" class="form-control text-white"> </div> </div> <div class="col-lg-12"> <div class="form-group">  </div> </div> <div class="col-lg-4 songwriters_track_' +
                i +
                '"> <div class="form-group"> <select name="songwriters_type[]" required id="" class="form-control"> <option value="Composer & Writer">Composer & writer</option> <option value="Composer">Composer</option> <option value="Lyricist">Lyricist</option> <option value="Producer">Producer</option> <option value="Publisher">Publisher</option> </select> </div> </div> <div class="col-lg-7 songwriters_track_' +
                i +
                '" > <div class="form-group"> <input type="text" name="songwriters_name[]" required id="" class="form-control text-white" placeholder="Name"> </div> </div> <div class="col-lg-1 songwriters_track_' +
                i +
                '" > <div class="form-group d-flex align-items-center form-remove-add-p2"><a href="javascript:;" id="songWriter" class="addInput" onclick="addInput($(this),3)" data-id="' +
                i +
                '">+</a></div> </div></div><div class="row bg-dark songWriterContent" style="padding-right:17px; padding-left:17px;"> </div>';
                    ...
                    success: function(res) {
                        ...
                        if (res.success == true) {
                            ...
                            $("#audioTracks").append('<input type="hidden" value="' + res.data +
                                '" id="track_' + res.data + '" name="audio_track[]">');
