...
@section('content')
    @if (settings()?->is_analytic_note == 1)
        <div class="row">
            <div class="col-md-12 text-center">
                <span style="background:#FFF301; color:black; padding:5px; font-size:11px">Dashboard Upgrade Ongoing. Some
                    Features Might Be Paused.</span>
            </div>
        </div>
    @endif
        ...
        <div class="col-12">
            <div class="card @if ($analytics == false) p-3 @endif">
                <div class="card-body">
                        ...
                        <div>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="javascript:;" onClick="lastdays('Last 7 Days')">Last
                                            7 Days</a></li>
                                    <li><a class="dropdown-item" href="javascript:;" onClick="lastdays('Last 15 Days')">Last
                                            15 Days</a></li>
                                    <li><a class="dropdown-item" href="javascript:;" onClick="lastdays('Last 45 Days')">Last
                                            45 Days</a></li>
                                    <li><a class="dropdown-item" href="javascript:;" onClick="lastdays('Last 60 Days')">Last
                                            60 Days</a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    @else
                        <center><span style="background:#FFF301; color:black; padding:5px; font-size:11px">Song Analytics
                                Unavailable for {{ request('last_days') ? request('last_days') : 'Last 7 Days' }}.</span>
                        </center>
                    @endif
    ...
    <section class="streames">
        ...
        <div class="row px-lg-4 px-0">
            <div class="col-12 text-end mt-4">
                <a href="{{ route('user.top', 'streams-by-number') }}"><button type="button"
                        class="btn btn-primary rounded">View More</button></a>
            </div>
        </div>
                            ...
                            <table class="table px-4 mb-0 home-table">
                                ...
                                @forelse(countriesTotals() as $key=>$value)
                                    @if ($count <= 6)
                                        <tr>
                                            <td class="ps-4 py-3">
                                                <img src="https://flagcdn.com/w80/{{ countryCode($key) }}.png"
                                                    width="25" class="me-2" alt="">
                                                <span>{{ $key }}</span>
                                            </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="2" class="text-center">
                                            <br>
                                            <center><span style="background:#FFF301; color:black; padding:1px">No record
                                                    found</span></center>
                                            <br>
                                        </td>
                                    </tr>
        ...
        <div class="row px-lg-4 px-0">
            <div class="col-12 text-end mt-4">
                <a href="{{ route('user.top', 'streams-by-country') }}"><button type="button"
                        class="btn btn-primary rounded">View More</button></a>
            </div>
        </div>
    ...
    <section class="revenue">
        ...
        <div class="row px-lg-4 px-0">
            <div class="col-12 text-end mt-4">
                <a href="{{ route('user.top', 'streams-by-revenue') }}"><button type="button"
                        class="btn btn-primary rounded">View More</button></a>
            </div>
        </div>
                    ...
                    @if ($count <= 4)
                        ...
                        <div class="card stream-card">
                            <div class="card-body py-5">
                                <img src="{{ asset(config('upload_path.album_artwork') . $r->album_artwork) }}"
                                    width="74" height="74" alt="" class="d-block">
    ...
    <div class="row px-lg-4 px-0">
        <div class="col-12 text-end mt-4">
            <a href="{{ route('user.top', 'top-performing-releases') }}"><button type="button"
                    class="btn btn-primary rounded">View More</button></a>
        </div>
    </div>
@endsection
        ...
        $(document).ready(function() {
            ...
            setTimeout(() => {
                var options = {
                    ...
                    series: [{
                        name: 'Streams',
                        data: @if (!empty($graphDataCounts))
                            <?php echo $graphDataCounts; ?>
                        @else
                            '[]'
                        @endif
                    }],
                    ...
                    xaxis: {
                        type: 'date',
                        categories: @if (!empty($graphDataDates))
                            <?php echo $graphDataDates; ?>
                        @else
                            '[]'
                        @endif ,
                        crosshairs: {
