...
@section('content')
                ...
                <div class="card">
                    <div class="card-body py-4 px-lg-4 px-2">
                        <div class="mb-lg-4 mb-3 input-icon position-relative">
                            ...
                            <select type="text" name="number_of_songs" id="number_of_songs" required
                                class="form-control custom-control w-100">
                        ...
                        <div class="mb-lg-4 mb-3">
                            ...
                            <input type="text" name="album_title" id="alTitle" required placeholder="Album Title"
                        ...
                        <div class="mb-lg-4 mb-3">
                            ...
                            <div class="form-check ">
                                <input class="form-check-input me-3" name="is_previous_released"type="radio"
                                    id="flexRadioDefault1" value="1" onchange="previousRelease($(this))">
                            ...
                            <div class="form-check ">
                                <input class="form-check-input me-3" name="is_previous_released" type="radio"
                                    value="0" id="flexRadioDefault2" checked onchange="previousRelease($(this))">
                            ...
                            <div class="mb-lg-4 mb-3" id="previousReleaseDate" style="display:none">
                                <input type="text" name="previous_release_date" id="previous_release_date"
                                    placeholder="Pick the previous date" class="form-control custom-control mt10px input"
                                    max="{{ date('Y-m-d') }}">
                        ...
                        <div class="mb-lg-4 mb-3">
                            ...
                            <input type="text" name="upc_code" id="upc"
                                placeholder="If you don’t have one. Leave blank we’ll generate one for free"
                                class="form-control custom-control">
                        </div>

                        <div class="mb-lg-4 mb-3">
                            <label for="" class="form-label">LABEL</label>
                            <input type="text" name="label" id="label" required placeholder="Label"
                                class="form-control custom-control">
                        </div>
                        <div class="mb-lg-4 mb-3">
                            <label for="" class="form-label">Version</label>
                            <input type="text" name="version" id="version" placeholder="Leave a blank if original"
                                class="form-control custom-control">
                        </div>
                        ...
                        <div class="" id="addMainPrimaryArtist">
                            <br>
                            <button onClick="mainArtist($(this))" data-type="main" data-location="release"
                                type="button" class="btn " style="background-color: #FFF301; color: #333;"><strong><i
                                        class="fa fa-plus"></i>&nbsp; Add Main Primary Artist</strong></button>
                        </div>
                        ...
                        <div class="mb-2 mt-2" id="addOtherKeyArtist" style="display: none">
                            <button onClick="mainArtist($(this))" data-type="other" data-location="release"
                                type="button" class="btn " style="background-color: #FFF301; color: #333;"><strong><i
                                        class="fa fa-plus"></i>&nbsp; Add Other Key Artist</strong></button>
                        </div>
                     ...
                     <div class="mb-lg-4 mb-3">
                        ...
                        <div class="mb-lg-4 mb-3 position-relative input-icon input-left-icon">
                            ...
                            <input type="date" name="release_date" id="release_date" required
                                class="form-control custom-control"><i class="left-icon"><img
                                    src="{{ asset('assets/portal-revamp/img/calender.png') }}" alt=""></i>
                        </div>
                        <div>
                            ...
                            <div class="mb-lg-4 mb-3 position-relative">
                                <span class="text-danger" id="sizeMsg" style="display:none">Image Size is greater than
                                    2048KB<br></span>
                                <small class="upload-msg text-danger" style="width:auto !important"></small>
                                <div class="image-album" style="display:none ;">
                                    <span class="cross">x</span>
                                    <img id="uploadedImage" src="#" alt="Uploaded Image"
                                        accept="image/png, image/jpeg" style="display:none; height:150px; width:150px"
                                        class="img-upload-album">
                                </div>

                                <input type="file" id="readUrl" name="album_artwork" required accept="image/*"
                                    class="form-control custom-control">
                                <img id="uploadedImage" src="#" alt="Uploaded Image"
                                    accept="image/png, image/jpeg" style="display:none; height:100px; width:100px;">
                            </div>
                        </div>

                        <div class="mb-lg-4 mb-3 position-relative input-icon">
                            <label for="" class="form-label">Primary Language</label>
                            <select id="exampleFormControlSelect2" name="language" required
                                class="form-control custom-control">
                        ...
                        <div class="mb-lg-4 mb-3 position-relative input-icon">
                            ...
                            <input type="text" name="catalog_id" id="catalog_id"
                                placeholder="Add your own catalog reference ID (Optional)"
                                class="form-control custom-control">
                        </div>
                        ...
                        <div class="d-md-flex justify-content-between gap-3">
                            <div class="mb-lg-4 mb-3 w-50    position-relative input-icon">
                                ...
                                <select name="p_copyright_year" id="p_copyright_year" class="form-control custom-control"
                                    required>
                            ...
                            <div class="mb-lg-4 mb-3 w-100 input-icon position-relative">
                                ...
                                <input type="text" name="p_copyright_name" id="p_copyright_name"
                                    placeholder="Name of individual/entity" class="form-control custom-control" required>
                            </div>
                        </div>
                        ...
                        <div class="d-md-flex justify-content-between gap-3">
                            <div class="mb-lg-4 mb-3 w-50    position-relative input-icon">
                                ...
                                <select name="c_copyright_year" id="c_copyright_year" class="form-control custom-control"
                                    required>
                                    <option value="">Select Year</option>
                                    @forelse (copyrightYear() as $copyright)
                                        <option value="{{ $copyright }}">{{ $copyright }}</option>
                            ...
                            <div class="mb-lg-4 mb-3 w-100 input-icon position-relative">
                                <label for="" class="form-label">&nbsp;</label>
                                <input type="text" name="c_copyright_name" id="c_copyright_name"
                                    placeholder="Name of individual/entity" class="form-control custom-control" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-lg-4 mb-3">
                            ...
                            <div class="stories mt-2 border p-3 pb-0">
                                @forelse ($stores as $item)
                                    <input type="hidden" name="stores[]" value="{{ $item->name }}"
                                        class="storeDetails_{{ $item->id }}">
                                    <span
                                        class="mx-2 mb-3 d-inline-block @if ($item->name != 'Spotify') showTimes @endif storeDetails_{{ $item->id }}"
                                        data-id="{{ $item->id }}"><a href="javascript:;"
                                            @if ($item->name != 'Spotify') onClick="removeStore({{ $item->id }})" @endif
                                            id="store_{{ $item->id }}" style="color:#FFF301"><img
                                                src="{{ asset('assets/icons/' . $item->logo) }}" width="45"
                                                height="45" alt="{{ $item->name }}"></a></span>
                                @empty
                                @endforelse
                            </div>
                        </div>
                        ...
                        <div id="track_1">
                            <div class="card-body py-4 px-lg-4 px-2">
                                <div class="mb-lg-4 mb-3">
                                    ...
                                    <input type="text" name="track_title" placeholder="Track Title"
                                        class="form-control custom-control track_title" required>
                                </div>
                                <div class="mb-lg-4 mb-3">
                                    <label for="track_version" class="form-label">Track Version</label>
                                    <input type="text" name="track_version" placeholder="Track Version"
                                        class="form-control custom-control track_version">
                                </div>
                                <div class="mb-lg-4 mb-3">
                                    <label for="isrc" class="form-label">ISRC CODE</label>
                                    <input type="text" id="isrc" name="track_isrc"
                                        placeholder="If you don’t have one. Leave blank we’ll generate one for free"
                                        class="form-control custom-control">
                                </div>
                            ...
                            <div class="mb-lg-4 mb-3">
                                ...
                                <div class="" id="addMainPrimaryArtistTrack">
                                    <br>
                                    <button onClick="mainArtist($(this))" data-type="main" data-location="track"
                                        type="button" class="btn "
                                        style="background-color: #FFF301; color: #333;"><strong><i
                                                class="fa fa-plus"></i>&nbsp; Add Main Primary Artist</strong></button>
                                </div>
                                ...
                                <div class="mb-2 mt-2" id="addOtherKeyArtistTrack" style="display: none">
                                    <button onClick="mainArtist($(this))" data-type="other" data-location="track"
                                        type="button" class="btn "
                                        style="background-color: #FFF301; color: #333;"><strong><i
                                                class="fa fa-plus"></i>&nbsp; Add Other Key Artist</strong></button>
                                </div>
                            ...
                            <div class="card-body border-top">
                                <div class="form-check ">
                                    <input class="form-check-input me-3" name="track_contains_1"type="radio"
                                        id="flexRadioDefault1" value="Contain Vocals">
                                    <label class="form-check-label" for="flexRadioDefault1">
                                ...
                                <div class="form-check mt-3">
                                    <input class="form-check-input me-3" name="track_contains_1"type="radio"
                                        value="Instrumental" id="flexRadioDefault2" checked>
                                    <label class="form-check-label" for="flexRadioDefault2">
                            ...
                            <div class="card-body border-top">
                                <div class="form-check">
                                    <input class="form-check-input me-3" type="radio" name="track_contains_2"
                                        id="flexRadioDefault21" value="Clean">
                                ...
                                <div class="form-check mt-3">
                                    <input class="form-check-input me-3" type="radio" name="track_contains_2"
                                        id="flexRadioDefault22" checked value="Explicit">
                                ...
                                <div class="form-check mt-3">
                                    <input class="form-check-input me-3" type="radio" name="track_contains_2"
                                        id="flexRadioDefault23" value="Radio Edit">
                            ...
                            <div class="card-body border-top">
                                <div class="mb-lg-4 mb-3 input-icon position-relative">
                                    ...
                                    <input type="text" id="track_language" name="track_language"
                                        placeholder="Language" required class="form-control custom-control">
                                </div>
                                <div class="">
                                    ...
                                    <div class="d-lg-flex d-block justify-content-between gap-3 align-items-center">
                                        <div class="mb-lg-4 mb-3 w-100 position-relative input-icon inc">
                                            ...
                                            <select name="songwriters_type[]" required
                                                class="form-control custom-control tracksongwriter_type">
                                        ...
                                        <div class="d-flex w-100 justify-content-between gap-3 align-items-center">
                                            <div class="mb-lg-4 mb-3 w-100">
                                                ...
                                                <input type="text" name="songwriters_name[]" required
                                                    placeholder="Name"
                                                    class="form-control custom-control tracksongwriter_name">
                                            </div>
                                            <div class="mb-lg-4 mb-3">
                                                <a href="javascript:;" id="songWriter" class="addInput"
                                                    onclick="addInput($(this),3)" data-id="0">
                                                    <span class="increament"> <i class="fa fa-plus"></i> </span>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="d-md-flex justify-content-between gap-3  ">
                                    <div class="mb-lg-4 mb-3 w-50    position-relative input-icon">
                                        <label for="" class="form-label">&#8471; Copyright</label>
                                        <select name="track_p_copyright_year" id="track_p_copyright_year"
                                            class="form-control custom-control">
                                            <option value="">Select Year</option>
                                            @forelse (copyrightYear() as $copyright)
                                                <option value="{{ $copyright }}">{{ $copyright }}</option>
                                    ...
                                    <div class="mb-lg-4 mb-3 w-100 input-icon position-relative">
                                        <label for="" class="form-label">&nbsp;</label>
                                        <input type="text" name="track_p_copyright_name" id="track_p_copyright_name"
                                            placeholder="Name of individual/entity" class="form-control custom-control">
                                    </div>
                                </div>
                    ...
                    <div class="card-body border-top">
                                    ...
                                    <div class="col-md-12">
                                        <div class="file-upload-wrapper" id="zdrop">
                                            <div class="card card-body w-100 view file-upload" id="upload-labels">
                                                <input type="file" onchange="previewFile(1)" name="track_audio_file"
                                                    accept="audio/wav"
                                                    class="audiofile a_1 browseFile audio-upload-file-input">
                                                <p class="file-upload-infos-message" id="audioMsg_1">Audio upload - Drag
                                                    and drop or click</p>
                                                <small class="text-danger" id="audioTrackMsg" style="display:none">Track
                                                    Size is larger than 30 MB</small>
                                            </div>
                                            <div class=" w-100 ">
                                                <audio controls src="" id="audio_1" width="100%"
                                                    style="background:rgb(255 243 1); display:none; width:100%"></audio>
                                            </div>
                                            <div style="display: none" class="progress mt-3" style="height: 25px">
                                                <div class="progress-bar     progress-bar-animated bg-warning progress-bar-striped text-dark"
                                                    role="progressbar" aria-valuenow="75" aria-valuemin="0"
                                                    aria-valuemax="100" style="width: 75%; height: 100%">75%</div>
                                            </div>
                                            <small style="display: none" class="showloaderMsg">Please do not close or
                                                refresh the browser. After this loading click on Add Track Button.</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="collection-item col-sm-6 mb-3 clearhack valign-wrapper item-template"
                                        ...
                                        <div class="left pv zdrop-info" data-dz-thumbnail>
                                            <div class="d-flex justify-content-between">
                                                <span data-dz-name></span> <span><a href="javascript:;" data-dz-remove
                        ...
                        <div class="row">
                            <div class="col-12 text-end">
                                <div id="createMode">
                                    <a href="#multiTracks">
                                        <button type="button" id="addTrack" data-id="1"
                                            onClick="uploadTrack($(this))" class="btn btn-primary rounded">Add Track <span
                                                id="addTrackCount">One</span></button>
                                    </a>
                                </div>
                                <div id="updateMode" style="display: none">
                                    <a href="#multiTracks">
                                        <button type="button" id="updateTrack" data-id="1"
                                            class="btn btn-primary rounded">Update Track</button>
                                    </a>
                                    &nbsp;&nbsp;
                                    <a href="#multiTracks">
                                        <button type="button" id="resetTrack" data-id="1"
                                            class="btn btn-primary rounded"
                                            style="color:white; background-color:black">Cancel</button>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body py-4 px-lg-4 px-2">
                        ...
                        <div class="mb-lg-4 mb-3">
                            <div class="form-check  mt-4">
                                <input class="form-check-input me-3" type="checkbox" name="check1" required
                                    id="check1">
                                <label class="form-check-label" for="flexCheckDefault">
                                    I accept that I can only upload audio that is music, and that ASMR, background sounds,
                                    etc. are not music.
                                </label>
                                <small id="check1Msg" class="text-danger"></small>
                            </div>
                            <div class="form-check  mt-4">
                                <input class="form-check-input me-3" type="checkbox" name="check2" required
                                    id="check2">
                            ...
                            <div class="form-check  mt-4">
                                <input class="form-check-input me-3" type="checkbox" name="check3" required
                                    id="check3">
                            ...
                            <div class="form-check  mt-4">
                                <input class="form-check-input me-3" type="checkbox" name="check4" required
                                    id="check4">
                            ...
                            <div class="form-check  mt-4">
                                <input class="form-check-input me-3" type="checkbox" name="check5" required
                                    id="check5">
                                <label class="form-check-label" for="flexCheckDefault3">
                        ...
                        <span class="ins d-block mt-4 mb-lg-4 mb-3">Add your First track this button will be enable on your
                            first upload. Upload Your Track and hit on Add Track button</span>
                        <div class="row">
                            <div class="col-12 ">
                                <span class="badge bg-danger mb-3" id="msg_no_of_songs" style="">You have selected
                                    <span class="no_of_songs"></span> tracks. Please upload <span
                                        class="no_of_songs"></span> tracks to enable this button</span>
                                <button id="createRelease" type="submit" class="btn btn-primary rounded w-100"
                                    disabled>Create Release</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="mainArtistModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    ...
                    <div class="row" id="roleDropDown" style="display:none">
                        <div class="col-md-12">
                            ...
                            {!! Form::select('role', artistNew(), null, [
                                'id' => 'role',
                                'class' => 'form-control select2Other',
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div style="float:right">
                                <button type="button" class="btn btn-primary bg-dark text-white"
                                    onClick="closeModal($(this))">Cancel</button>&nbsp;
                                <button class="btn btn-primary artistType" onClick="addArtistDetail($(this))">Add
                                    Artist</button>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="createAndNewArtistModal" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <form method="post" id="addNewArtist" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="name" id="newArtistName" class="form-control"
                                    placeholder="Offical name" required>
                                <small style="color:rgb(147, 143, 143);">The artist name must be written exactly as you
                                    want it to appear on music services suchas Spotify, Apple Music, etc</small>
                            </div>
                            <div class="col-md-12 mt-3">
                                <label for="" class="form-label text-white">Is there Artist on Spotify? (required
                                    when distributing to Spotify)</label>
                                <div class="form-check ">
                                    <input class="form-check-input me-3" name="spotify_profile_link" type="radio"
                                        value="1" id="flexRadioDefault102" onChange="spotifyProfileLink($(this))">
                                ...
                                <div class="form-check ">
                                    <input class="form-check-input me-3" name="spotify_profile_link" type="radio"
                                        id="flexRadioDefault101" value="0" checked
                                        onChange="spotifyProfileLink($(this))">
                                    <label class="form-check-label" for="flexRadioDefault101">
                                        <span class="custom-label text-white">No, create a new Spotify profile for this
                                            artist</span>

                                    </label>
                                </div>
                                <div class="spotifyProfileLink" style="display:none">
                                    <input type="url" name="spotify_link" id="spotify_link" class="form-control"
                                        placeholder="Artist Spotify Profile Link">
                                </div>
                            </div>

                            <div class="col-md-12 mt-3">
                                <label for="" class="form-label text-white">Is there Artist on Apple Music?
                                    (required when distributing to Apple Music)</label>
                                <div class="form-check ">
                                    <input class="form-check-input me-3" name="apple_music_profile_link" type="radio"
                                        value="1" id="flexRadioDefault202"
                                        onChange="appleMusicProfileLink($(this))">
                                ...
                                <div class="form-check ">
                                    <input class="form-check-input me-3" name="apple_music_profile_link" type="radio"
                                        id="flexRadioDefault201" value="0" checked
                                        onChange="appleMusicProfileLink($(this))">
                                    <label class="form-check-label" for="flexRadioDefault201">
                                        <span class="custom-label text-white">No, create a new Apple Music profile for this
                                            artist</span>

                                    </label>
                                </div>
                                <div class="appleMusicProfileLink" style="display:none">
                                    <input type="url" name="apple_music_link" id="apple_music_link"
                                        class="form-control" placeholder="Artist Apple Music Profile Link">
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        function artist(count) {
            ...
            var html =
                ' <div class="d-lg-flex justify-content-between gap-3 align-items-center "><div class="mb-lg-4 mb-3 w-100 input-icon inc position-relative artist_' +
                count +
                '"><select  class="form-control custom-control artist" id="exampleFormControlSelect2" name="artist[' +
                count +
                '][type]" required ><option value="primary artist">Primary Artist</option><option value="featured artist">Featured Artist</option><option value="producer artist">Producer</option><option value="remixer artist">Remixer</option></select><i class="fa-solid fa-chevron-down select-icon"></i></div><div class="d-flex w-100 justify-content-between gap-3 align-items-center artist_' +
                count + '"><div class="mb-lg-4 mb-3 w-100"><input type="text"  name="artist[' + count +
                '][name]"  placeholder="Artist Name" class="form-control custom-control artist_name" required></div><div class="mb-lg-4 mb-3 artist_' +
                count +
                '"><a href="javascript:;" style="text-decoration:none !important" class="removeInput" onClick="removeInput($(this))" data-id=' +
                count +
                ' data-type="artist"><span class="increament bg-danger"><i class="fa fa-times"></i></span></a></div></div></div>';
            return html;
        }
        ...
        function track(count) {
            ...
            var html =
                '<div class="d-lg-flex d-block justify-content-between gap-3 align-items-center "><div class="mb-lg-4 mb-3 w-100 position-relative input-icon inc artist_track_' +
                count +
                '"><select id="exampleFormControlSelect2" name="artist_track_type[]" required  class="form-control custom-control"><option value="primary artist">Primary Artist</option><option value="featured artist">Featured Artist</option><option value="producer artist">Producer</option><option value="remixer artist">Remixer</option></select><i class="fa-solid fa-chevron-down select-icon"></i></div><div class="mb-lg-4 mb-3 w-100 artist_track_' +
                count +
                '"><input type="text" name="artist_track_name[]" required placeholder="Artist Name" class="form-control custom-control artist_name"></div><div class="mb-lg-4 mb-3 w-100 artist_track_' +
                count +
                '"><input type="text" name="artist_track_spotify[]" required placeholder="Spotify Link. Leave blank if you do not have any" class="form-control custom-control artist_spotify"></div><div class="mb-lg-4 mb-3 w-100 artist_track_' +
                count +
                '"><input type="text" name="artist_track_apple[]" required placeholder="Apple Link. Leave blank if you do not have any" class="form-control custom-control artist_apple"></div><div class="mb-lg-4 mb-3 artist_track_' +
                count +
                '"><a href="javascript:;" style="text-decoration: none !important" class="removeInput" onClick="removeInput($(this))" data-id=' +
                count +
                ' data-type="artistTrack"><span class="increament bg-danger"><i class="fa fa-times"></i></span></a></div></div>';
            return html;
        }
        ...
        function songWriters(count) {
            ...
            var html =
                '<div class="d-lg-flex d-block justify-content-between gap-3 align-items-center "><div class="mb-lg-4 mb-3 w-100 position-relative input-icon inc songwriters_track_' +
                count +
                '"><select  name="songwriters_type[]" required class="form-control custom-control tracksongwriter_type"><option value="Composer &amp; writer">Composer &amp; writer</option><option value="Composer">Composer</option><option value="Lyricist">Lyricist</option><option value="Publisher">Publisher</option></select><i class="fa-solid fa-chevron-down select-icon"></i></div><div class="d-flex w-100 justify-content-between gap-3 align-items-center songwriters_track_' +
                count +
                '"><div class="mb-lg-4 mb-3 w-100"><input type="text" name="songwriters_name[]" required placeholder="Name" class="form-control custom-control tracksongwriter_name"></div><div class="mb-lg-4 mb-3 songwriters_track_' +
                count +
                '"><a href="javascritpt:;" style="text-decoration:none !important" class="removeInput" onClick="removeInput($(this))" data-id="' +
                count +
                '" data-type="songWriter"><span class="increament bg-danger"> <i class="fa fa-times"></i> </span></a></div></div></div>';
            return html;
        }
            ...
            if (this.files[0]) {
                ...
                picture.addEventListener('load', function(event) {
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            // if (parseInt(pictureSize) > 2048000 || parseInt(pictureSize) == 2048000) {
                            ...
                            if (validate == true) {
                                ...
                                document.getElementById('uploadedImage').style.display =
                                    'block';
                                document.querySelector('.image-album').style.display =
                                    'block';
                                document.querySelector('.upload-msg').style.display =
                                    'none';
        ...
        function multiTrack(count, trackId, track_title, track_version) {
            var trackVersion = track_version ? ' (' + track_version + ')' : "";
            $("#uploadedTracks").append('<div id="remove_track_' + trackId + '" data-id="' + trackId +
                '" class="sortable-item stories mt-2 border p-3"><div class="row"><div class="col-1"><small>&nbsp;</small><h4 >' +
                count + '</h4></div><div class="col-9"><small>Track Name</small><h4 id="track_name_' + trackId +
                '"style="color: var(--primary)">' + track_title + trackVersion +
                '</h4></div><div class="col-md-2"><div class="row"><div class="col-6 text-center"><small>Edit</small><br><a href="#multiTracks" onClick="editTrackv2(' +
                trackId + ',' + count +
                ')"><span><i class="fa fa-pencil-square" style="color:var(--primary); font-size:30px"></i></span></a></div><div class="col-6 "><small>Remove</small><br><a href="javascript:;" onClick="removeTrack(' +
                trackId +
                ',$(this),null)"><span><i class="fa fa-minus-square" style="color:var(--primary); font-size:30px;"></i></span></a></div></div></div><input type="hidden" value="' +
                trackId + '" id="track_sortable' + trackId + '" name="audio_track_sortable[]" ></div>');
        }
        ...
        function noOfSongs(i) {
            text = '<div id="track_' + i +
                '"><div class="card-body py-4 px-lg-4 px-2"><div class="mb-lg-4 mb-3"><label for="track_title" class="form-label">Track Title</label><input type="text" name="track_title" id="track_title_' +
                i +
                '"  placeholder="Track Title" class="form-control custom-control track_title" required></div><div class="mb-lg-4 mb-3"><label for="track_version" class="form-label">Track Version</label><input type="text" name="track_version" id="track_version_' +
                i +
                '"  placeholder="Track Version" class="form-control custom-control track_version" required></div><div class="mb-lg-4 mb-3"><label for="isrc" class="form-label">ISRC CODE</label><input type="text" id="isrc" name="track_isrc" placeholder="If you don’t have one. Leave blank we’ll generate one for free" class="form-control custom-control"></div><div id="createAddArtistIdTrack"></div><div class=""><label for="" class="">Artist</label></div><div class="" id="addMainPrimaryArtistTrack"><br><button onclick="mainArtist($(this))" data-type="main" data-location="track" type="button" class="btn " style="background-color: #FFF301; color: #333;"><strong><i class="fa fa-plus"></i>&nbsp; Add Main Primary Artist</strong></button></div><div id="mainArtistDetailTrack"></div><div id="otherArtistDetailTrack" class="mt-4"></div><div class="mb-2 mt-2" id="addOtherKeyArtistTrack" style="display: none"><button onclick="mainArtist($(this))" data-type="other" data-location="track" type="button" class="btn " style="background-color: #FFF301; color: #333;"><strong><i class="fa fa-plus"></i>&nbsp; Add Other Key Artist</strong></button></div><div class="d-lg-flex d-block justify-content-between gap-3 align-items-center "><div class="trackArtist"></div></div>';
            text +=
                '<div class="card-body border-top"><div class="form-check "><input class="form-check-input me-3" name="track_contains_1"type="radio" id="flexRadioDefault1' +
                i +
                '" value="Contain Vocals"><label class="form-check-label" for="flexRadioDefault1"><span class="custom-label">Contain Vocals</span><br>My Song contains lyrics and vocals</label></div><div class="form-check mt-3"><input class="form-check-input me-3" name="track_contains_1"type="radio" value="Instrumental"  id="flexRadioDefault2 ' +
                i +
                '" checked><label class="form-check-label" for="flexRadioDefault2"><span class="custom-label">Instrumental</span><br>My Song contains no lyrics and vocals</label></div></div><div class="card-body border-top"><div class="form-check"><input class="form-check-input me-3" type="radio" name="track_contains_2" id="flexRadioDefault21' +
                i +
                '" value="Clean"><label class="form-check-label" for="flexRadioDefault21"><span class="custom-label">Clean</span><br>My Song does not contain any profanity (Includes title & artwork)</label></div><div class="form-check mt-3"><input class="form-check-input me-3" type="radio" name="track_contains_2" id="flexRadioDefault22' +
                i +
                '" checked value="Explicit"><label class="form-check-label" for="flexRadioDefault22"><span class="custom-label">Explicit</span><br>My Song contain any profanity (Includes title & artwork)</label></div><div class="form-check mt-3"><input class="form-check-input me-3" type="radio" name="track_contains_2" id="flexRadioDefault23' +
                i +
                '" value="Radio Edit"><label class="form-check-label" for="flexRadioDefault23"><span class="custom-label">Radio Edit</span><br>The track is clean/censored, but have a explict version.</label></div></div><div class="card-body border-top"><div class="mb-lg-4 mb-3 input-icon position-relative"><label for="" class="form-label">Language</label><input type="text" id="track_language" name="track_language" placeholder="Language" required class="form-control custom-control"></div><div class="d-lg-flex d-block justify-content-between gap-3 align-items-center "><div class="mb-lg-4 mb-3 w-100 position-relative input-icon songwriters_track_' +
                i +
                '"><label for="" class="form-label">Song Writers</label><select  name="songwriters_type[]" required class="form-control custom-control tracksongwriter_type"><option value="Composer &amp; writer">Composer &amp; writer</option><option value="Composer">Composer</option><option value="Lyricist">Lyricist</option><option value="Producer">Producer</option><option value="Publisher">Publisher</option></select><i class="fa-solid fa-chevron-down select-icon"></i></div><div class="d-flex w-100 justify-content-between gap-3 align-items-center songwriters_track_' +
                i +
                '"><div class="mb-lg-4 mb-3 w-100"><label for="" class="form-label opacity-0">sfsa</label><input type="text" name="songwriters_name[]" required placeholder="Name" class="form-control custom-control tracksongwriter_name"></div><div class="songwriters_track_' +
                i + '"><a href="javascript:;" id="songWriter" class="addInput" onclick="addInput($(this),3)" data-id="' +
                i +
                '"><span class="increament"> <i class="fa fa-plus"></i> </span></a></div></div></div><div class=" songWriterContent" style=""></div><div class="trackContent"></div><div class="d-md-flex justify-content-between gap-3 border-top"> <div class="mb-lg-4 mb-3 w-50    position-relative input-icon "> <label for="" class="form-label">&#8471; Copyright</label> <select name="track_p_copyright_year" id="track_p_copyright_year"  class="form-control custom-control" > <option value="">Select Year</option> @forelse (copyrightYear() as $copyright) <option value="{{ $copyright }}">{{ $copyright }}</option> @empty @endforelse </select> <i class="fa-solid fa-chevron-down select-icon"></i> </div> <div class="mb-lg-4 mb-3 w-100 input-icon position-relative"> <label for="" class="form-label">&nbsp;</label> <input type="text" name="track_p_copyright_name" id="track_p_copyright_name" placeholder="Name of individual/entity" class="form-control custom-control" > </div> </div></div>';
        ...
        function uploadTrack(elm) {
            ...
            if (artist_ids != "" && track_title != "" && track_language != "" && songwriters_name != "" &&
                track_audio_file != undefined) {
                ...
                $.ajax({
                    ...
                    beforeSend: function(res) {
                        $("#loaderMsg").html(
                            'Please Wait..<br>It takes time<br>Depends on the size of Wav File');
                        $('.loader').show();
                    },
                    success: function(res) {
                        ...
                        if (res.success == true) {
                            ...
                            $("#audioTracks").append('<input type="hidden" value="' + res.data +
                                '" id="track_' + res.data + '" name="audio_track[]" data-id="' + parseInt(
                                    count - 1) + '">');
        ...
        function editTrackv2(id, count) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $("#audioMsg_1").html(res.audio_track +
                        '</br>Audio upload - Drag and drop or click to change the track');
        ...
        $("#updateTrack").click(function() {
            ...
            if (track_title != "" && artist_ids_track != "" && track_language != "" && songwriters_name != "" &&
                track_audio_file != undefined) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.success == true) {
                            ...
                            $("#createMode").show();
                            $("#updateMode").hide();
                            if (res.track_version == "" || res.track_version == null) {
                                var trackTitleAndVersion = res.track_title;
                            } else {
                                var trackTitleAndVersion = res.track_title + ' (' + res.track_version +
                                    ')';
                            }
        ...
        function formatOption1(option) {
            ...
            if (!isCustomButtonAppended) {
                ...
                var $customButton = $(
                    '<button class="btn btn-primary w-100 createAndNew" style="margin-bottom:0px;" onClick="createAndNewArtist($(this))">CREATE AND ADD A NEW ARTIST</button>'
                );
                ...
                success: function(res) {
                    ...
                    if (res.success == true) {
                        if (res.type == 'main' && location == 'release') {
                            ...
                            $("#createAddArtistId").append('<input type="hidden" id="artistIds_' + res
                                .artist_id + '" value="' + res.artist_id +
                                '"  name="artist_id[]"><input type="hidden" id="artistRoles_' + res
                                .artist_id + '" value="main primary"  name="artist_role[]">');
                            ...
                            $("#createAddArtistId").append('<input type="hidden" id="artistIds_' + res
                                .artist_id + '" value="' + res.artist_id +
                                '"  name="artist_id[]"><input type="hidden" id="artistRoles_' + res
                                .artist_id + '" value="' + role + '"  name="artist_role[]">');
                            ...
                            $("#createAddArtistIdTrack").append('<input type="hidden" id="trackArtistIds_' + res
                                .artist_id + '" value="' + res.artist_id +
                                '"  name="artist_id_track[]"><input type="hidden" id="trackArtistRoles_' +
                                res.artist_id + '" value="main primary"  name="artist_role_track[]">');
                            ...
                            $("#createAddArtistIdTrack").append('<input type="hidden" id="trackArtistIds_' + res
                                .artist_id + '" value="' + res.artist_id +
                                '"  name="artist_id_track[]"><input type="hidden" id="trackArtistRoles_' +
                                res.artist_id + '" value="' + role + '"  name="artist_role_track[]">');
