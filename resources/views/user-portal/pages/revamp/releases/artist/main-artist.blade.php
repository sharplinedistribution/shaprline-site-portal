...
<div class="col-md-4 border border-primary artist_remove" style="border-color:#FFF301 !important; border-radius: 8px;" id="artist_{{$artist->id}}">
    <div class="row p-2">
        <div class="col-2">
        ...
        <div class="col-6 text-left">
            <h5 style="color:#FFF301">{{ $artist->name }}</h5>
            <small style="color:#FFF301">{{  ucwords($role) }} Artist</small>
        </div>
        <div class="col-4" >
